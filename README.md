...
| **Anthropic** — [11 Certificates of Completion](https://ethanstoner.github.io/certs) | Anthropic API, Code in Action, Code 101, Model Context Protocol (MCP) + Advanced, AI Fluency for Builders, AI Fluency, Platform 101, Claude 101, AI Fluency for Students & Cowork |
